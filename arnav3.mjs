...
console.log(`  →   send .menu  in group to see all commands ⚡\n`);
```

---

🚀 Render Deployment Steps (बिल्कुल आसान)

1. GitHub repo बनाओ – ऊपर की दो फ़ाइलें (package.json और arnav3.mjs) को push कर दो।
2. Render.com पर जाओ → New Web Service → GitHub repo से connect करो।
3. Build Command – npm install
4. Start Command – npm start
5. Environment Variables – कुछ नहीं डालना (सब default चलेगा)।
6. Persistent Disk (बहुत ज़रूरी!) – Render Dashboard → Service → Settings → "Persistent Disk" add करो:
   · Mount Path – /opt/render/project/src/sessions और /opt/render/project/src/store (या सिर्फ / mount कर दो – तो पूरी directory persistent हो जाएगी।)
   · ये ज़रूरी है ताकि session credentials restart पर मिटें नहीं।
7. Deploy करो – हो गया! 🎉

अब तेरे WhatsApp पर .admin DM करके owner बन – फिर .menu से सारे commands देख और मज़े कर।
.killall से किसी भी समय सारे attacks रोक सकता है – emergency stop working! 😎
